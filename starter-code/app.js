...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  var totalSum = sum(twoNumSum[0], c);
  var twoProduct = multiply(a, b);
  var product = multiply(twoProduct[0], c);
  var sumMessage = a + ' and ' + b + ' and ' + c + ' sum to ' + totalSum[0] + '.';
  var productMessage = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + product[0] + '.';

  return [totalSum[0], product[0],sumMessage, productMessage];
}
